...
export default {
  ...
  methods: {
    ...
    overlapCheck: function () {
      axios
        .get(`https://i4a406.p.ssafy.io:5000/room/overlap/${this.room.title}`)
        .then((response) => {
    ...
    makeroomCheck: function () {
      ...
      if (!err) alert(msg);
        ...
        axios
          .post(`https://i4a406.p.ssafy.io:5000/room/makeroom`, this.room)
          .then((response) => {
            ...
            if (document.getElementById("upload").files[0]) {
              ...
              axios
                .post(`https://i4a406.p.ssafy.io:5000/imgs/saveThumbnail`, fd)
                .then();
            }
            this.$router.push({
              name: "IntoRoom",
